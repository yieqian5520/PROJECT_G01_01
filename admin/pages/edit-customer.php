...
/* =======================
   Load staff user (same as staff_dashboard)
======================= */
...
$cStmt = $db->prepare("
    SELECT id, name, phone, email, address, verify_status
    FROM users
    WHERE id = ?
");
...
/* Right panel latest feedback (same as staff_dashboard) */
$latestFeedback = [];
...
<head>
    ...
    <style>
        /* your CSS uses this but it's missing in :root sometimes */
        :root { --color-dark-variant: #677483; }

        /* Page card – consistent with your profile/dashboard cards */
        .edit-card{
...
<div class="container">
    ...
    <!-- ASIDE (same as your staff_dashboard) -->
    <aside>
        <div class="top">
            <div class="logo">
        ...
        <div class="sidebar">
            ...
            <a class="active" href="staff_dashboard.php?tab=customers">
    ...
    <main>
        <div class="edit-head">
            <div>
                <h1>Edit Customer</h1>
                <p class="sub">Update customer details and verification status.</p>
            </div>
        ...
        <div class="edit-card">
            <form method="POST" action="update-customer.php" autocomplete="off">
                ...
                <div class="actions">
                    <a class="btn btn-outline" href="staff_dashboard.php?tab=customers">Back</a>
